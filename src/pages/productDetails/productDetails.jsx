...
const ProductDetails = () => {
    ...
    const fetchProductAndComments = async () => {
      try {
        const productResponse = await axios.get(
          `https://ecommerce-h-r.onrender.com/products/${id}`
        );
        setProduct(productResponse.data);

        const commentsResponse = await axios.get(
          `https://ecommerce-h-r.onrender.com/products/${id}/comments`
        );
  ...
  const handleAddComment = async () => {
    try {
      ...
      await axios.post(`https://ecommerce-h-r.onrender.com/${id}/comments`, {
        text: newCommentText,
      });
    } catch (error) {
